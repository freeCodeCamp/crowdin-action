...
exports.hideSpecificString = void 0;
const files_1 = require("../utils/files");
const strings_1 = require("../utils/strings");
/**
 * Module to hide a specific string on Crowdin.
 *
 ...
 * @returns {Promise<boolean>} True if the string was hidden, false otherwise.
 */
const hideSpecificString = (projectId, fileName, string) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield strings_1.CrowdinStringHelper.changeHiddenStatus(projectId, targetString.data.id, true);
    return true;
});
